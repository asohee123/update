...
public class BookstoreService {
	...
	public void retrieveUserInfo(int userNo) {
		...
		System.out.println("탈퇴여부: " + (user.isDisabled ? "예" : "아니오"));
		System.out.println("================================================================================");
	}
	...
	public void retrieveAllUsers() {
		...
		for (User user : users) {
			...
			System.out.println(user.isDisabled ? "예" : "아니오");
		}
		System.out.println("================================================================================");
	}
	...
	private void printRentals(Rental[] rentals) {
		...
		System.out.println("================================================================================");
		System.out.println("대여번호	책번호	책제목		회원번호	회원이름	대여상태");
		System.out.println("--------------------------------------------------------------------------------");
		...
		for (Rental rental : rentals) {
			...
			System.out.print(user.no + "\t");
			System.out.print(user.name + "\t");
			System.out.println(rental.isRent ? "대여중" : "반납완료");
		}
		System.out.println("================================================================================");
	}
