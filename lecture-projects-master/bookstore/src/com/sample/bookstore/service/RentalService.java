...
public class RentalService {
	...
	public RentalService() {
		db[position++] = new Rental(rentalSequence++, 10001, 20001, true);
		db[position++] = new Rental(rentalSequence++, 10001, 20002, true);
		db[position++] = new Rental(rentalSequence++, 10002, 20001, true);
		db[position++] = new Rental(rentalSequence++, 10003, 20001, false);
		db[position++] = new Rental(rentalSequence++, 10004, 20003, true);
	}
