	 			...
	 			<div class="modal-content">
	   				...
	   				<div class="modal-body">
		   				...
		   				<div class="row" id="fail-msg-row" style="display: none;">
		   					<div class="col-12">
		   						<div class="alert alert-success">
		   							<strong>실패</strong > 회원가입이 성공하지 못했습니다..
		   						</div>
		   					</div>
		   				</div>
	     				<div class="row">
		...
		<div class="modal-dialog">
			<form method="post" action="login.hta">
	 			<div class="modal-content">
	   				...
	   				<div class="modal-body">
		   				<div class="row" id="login-success-msg-row" style="display: none;">
			   				<div class="col-12">
			   					<div class="alert alert-success">
			   						<strong>성공</strong> 로그인 성공
			   					</div>
			   				</div>
			   			</div>
		...
		function registerUser(){
			...
			xhr.onreadystatechange = function(){
				if(xhr.readyState == 4 && xhr.status == 200){
					...
					var resData = JSON.parse(text); // resDate -> {result:true}로 변환됨
					if (resData.result) {
