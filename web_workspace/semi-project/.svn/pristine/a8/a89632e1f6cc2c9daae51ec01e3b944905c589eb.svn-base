...
%>
	<div class="row justify-content-md-center">
		<div class="col-5">
			<h2 class="text-center mb-5">Find Password</h2>
		...
		%>
			...
			<form action="changePasswordForm.jsp" method="post">
				<label>타입:</label>
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" placeholder="Enter Id" name="id" id="userId"
