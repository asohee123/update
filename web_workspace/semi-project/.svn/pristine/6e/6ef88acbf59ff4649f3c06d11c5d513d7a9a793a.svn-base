...
<div class="container">  
	<nav class="navbar navbar-expand justify-content-center navbar-light">
	  	<ul class="navbar-nav">
		    ...
		    <li class="nav-item">
		      <a class="nav-link disabled" href="../product/registerForm.jsp" style="padding-left: 40px;">상품등록</a>
		    </li>
		    <li class="nav-item" style="padding-left: 40px; padding-right: 40px">
		      <a class="nav-link" href="deliver.jsp">배송관리</a>
		    </li>
		    <li class="nav-item">
	...
	<form action="productRegister.jsp" method="post" enctype="multipart/form-data">
		<h3 class="card-title text-center" >상품등록</h3>
		<hr>
