						...
						<div class="card mb-3">
							<div class="card-body p-2">
								<div class="border border-top-0 border-right-0 border-left-0 pb-1">
									...
									<span class="float-right text-secondary"><fmt:formatDate value="${reviews.registeredDate }" pattern="yyyy.MM.dd"/></span>
								</div>
								<div class="mt-2">
									<c:out value="${reviews.content }"/>
									<c:if test="${reviews.userId eq loginUser.id }">
										<a href="delReview.hta?reviewno=${reviews.no }" class="btn btn-danger btn-sm float-right">x</a>
									</c:if>
