...
public class DataTypeDemo9 {
	...
	public static void main(String[] args) {
		...
		int shosePrice = 500000;
		
		int shirttotal = shirt * shirtPrice;
		int jeanstotal = jeans * jeansPrice;
		int shosetotal = shose * shosePrice;
		...
		System.out.println("적립금액 : " + (int)(total*0.03));
